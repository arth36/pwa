<template>
  <div v-if="$router.currentRoute.name.includes('odiScore')===false">
    ...
    <h1 class="header my-2 white--text">Odi</h1>
  ...
  <div v-else-if="$router.currentRoute.name.includes('odiScore')">
    <keep-alive>
